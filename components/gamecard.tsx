...
const games = [
  {
    ...
    background: '/assets/images/axie.png',
    logo: '/assets/images/axie_logo.png',
    name: 'Axie Infinity',
    description:
  ...
  },
  {
    ...
    background: '/assets/images/ember_sword.png',
    logo: '/assets/images/ember_logo.webp',
    name: 'Ember Sword',
    description:
  ...
  {
    id: 3,
    background: '/assets/images/guild_of_guardians.png',
    alt: 'Media kit image of Guild of Guardians with logo',
    logo: '/assets/images/guardians_logo.png',
  ...
  },
  {
    ...
    background: '/assets/images/illuvium.png',
    logo: '/assets/images/illuvium_logo.png',
    name: 'Illuvium',
    description:
  ...
  },
  {
    ...
    background: '/assets/images/civitas.jpg',
    logo: '/assets/images/civitas_logo.png',
    name: 'Civitas',
    description:
  ...
  },
  {
    ...
    background: '/assets/images/pet_hooligan.jpg',
    logo: '/assets/images/hooligan_logo.png',
  ...
  },
  {
    ...
    background: '/assets/images/crypto_unicorns.webp',
    logo: '/assets/images/unicorns_logo.png',
  ...
  },
  {
    ...
    background: '/assets/images/thetan_arena.png',
    logo: '/assets/images/thetan_logo.png',
    name: 'Thetan Arena',
  ...
  {
    id: 9,
    background: '/assets/images/influence.png',
    logo: '/assets/images/influence_logo.png',
    name: 'Influence',
    description:
...
export const GameCard = () => {
  ...
  return (
    <div id='card_wrapper' style={{ margin: '5% 9.5%' }}>
      {games.map((game) => (
        <motion.div
